...
class TinkoffExchangeInterface:
    ...
    def get_positions(self):
        ...
        try:
            ...
            position = {
                "average_price": position[0]["averagePositionPrice"]["value"],
    ...
    def get_last_order_price(self, side):
        ...
        params = {"from": _from, "to": _to, "figi": self.figi}
        result = self._get(method, params=params)
        last_order_price = [
            order.get("price")
    ...
    def get_open_orders(self):
        ...
        try:
            open_orders = [
                position
                for position in self._get(method)
    ...
    def get_orders_state(self, orders_state):
        ...
        result = self._get(method, params=params)
        orders = [
            self.get_order_params_from_responce(
                {
